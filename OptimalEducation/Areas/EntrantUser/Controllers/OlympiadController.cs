...
using OptimalEducation.DAL.Commands.ParticipationInOlympiad;
    ...
    public class OlympiadController : Controller
    {
        ...
        public async Task<ActionResult> Details(int? id)
        {
            ...
            var participationinolympiads = await _queryBuilder.For<Task<ParticipationInOlympiad>>()
                .With(new GetCurrentParticipationInOlympiadCriterion
                {
                    EntrantId = entrantId,
                    ParticipationInOlympiadId = poId
                });
        ...
        public async Task<ActionResult> Delete(int? id)
        {
            ...
            var participationinolympiad = await _queryBuilder
                ...
                {
                    EntrantId = entrantId,
                    ParticipationInOlympiadId = participationInOlympiadId
                });
        ...
        public async Task<ActionResult> DeleteConfirmed(int id)
        {
            ...
            await _commandBuilder
                .ExecuteAsync(new RemoveParticipationInOlympiadContext
                {
                    EntrantId = entrantId,
                    ParticipationInOlympiadId = id
                });
