...
namespace OptimalEducation.Logic.Characterizer
{
    public static class CharacteristicDistance
    {
        ...
        public static double? GetDistance(Dictionary<string, double> entrantCharacteristics, Dictionary<string, double> educationLineCharacteristics)
        {
            //Выбрать здесь метод, который будет использоваться для вычисления
            //return GetEuclidDistance(entrantCharacteristics, educationLineCharacteristics);
