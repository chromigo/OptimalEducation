...
namespace OptimalEducation.Implementation.Logic.DistanceRecomendator
{
    public static class CharacteristicDistance
    {
        ...
        public static double? GetDistance(Dictionary<string, double> entrantCharacteristics,
            Dictionary<string, double> educationLineCharacteristics)
        {
            //Выбрать здесь метод, который будет использоваться для вычисления
            return GetCityBlockDistance(entrantCharacteristics, educationLineCharacteristics);
        }
        ...
        private static double? GetEuclidDistance(Dictionary<string, double> entrantCharacteristics,
            Dictionary<string, double> educationLineCharacteristics)
        {
        ...
        /// <param name="entrantCharacteristics">Значение вычисленного кластера для данного абитуриента</param>
        /// <param name="educationLineCharacteristics">Значение вычисленного кластера для данного учебного направления</param>
        private static double? GetSquareEuclidDistance(Dictionary<string, double> entrantCharacteristics,
            Dictionary<string, double> educationLineCharacteristics)
        {
        ...
        /// <param name="entrantCharacteristics">Значение вычисленного кластера для данного абитуриента</param>
        /// <param name="educationLineCharacteristics">Значение вычисленного кластера для данного учебного направления</param>
        private static double? GetCityBlockDistance(Dictionary<string, double> entrantCharacteristics,
            Dictionary<string, double> educationLineCharacteristics)
        {
        ...
        /// <param name="entrantCharacteristics">Значение вычисленного кластера для данного абитуриента</param>
        /// <param name="educationLineCharacteristics">Значение вычисленного кластера для данного учебного направления</param>
        private static double? GetChebishevDistance(Dictionary<string, double> entrantCharacteristics,
            Dictionary<string, double> educationLineCharacteristics)
        {
        ...
        private static double? GetPowerDistance(Dictionary<string, double> entrantCharacteristics,
            Dictionary<string, double> educationLineCharacteristics, double p, double r)
        {
